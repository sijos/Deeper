...
myNameJeff =  { username: 'myNameJeff', password: 'password' }
EuroDude =  { username: 'EuroDude', password: 'password' }
ChaletAllDay =  { username: 'ChaletAllDay', password: 'password' }

User.create([scott, zestyyy, rage, penguin, Skimax, Randy, kale, powderHound, doneSki, oreo, GuestUser, dellyBird, andhudhow, myNameJeff, EuroDude, ChaletAllDay])
